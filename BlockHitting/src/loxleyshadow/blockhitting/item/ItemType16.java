...
public class ItemType16 {
	...
	public static NBTTagCompound getSwordType(SwordType type) {
		switch (type) {
		case WOOD:
			return Storage16.damagetag16.get("wood");

		case STONE:
			return Storage16.damagetag16.get("stone");

		case IRON: 
			return Storage16.damagetag16.get("iron");

		case GOLD:
			return Storage16.damagetag16.get("gold");

		case DIAMOND:
			return Storage16.damagetag16.get("diamond");
			
		case NETHERITE:
			return Storage16.damagetag16.get("netherite");
	...
	public static Boolean isSword(Material mat) {
		return mat == Material.WOODEN_SWORD || mat == Material.STONE_SWORD || mat == Material.IRON_SWORD || mat == Material.GOLDEN_SWORD || mat == Material.DIAMOND_SWORD || mat == Material.NETHERITE_SWORD;
	}
