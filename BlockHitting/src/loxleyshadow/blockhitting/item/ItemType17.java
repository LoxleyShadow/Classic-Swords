...
public class ItemType17 {
	...
	public static NBTTagCompound getSwordType(SwordType type) {
		switch (type) {
		case WOOD:
			return Storage17.damagetag17.get("wood");

		case STONE:
			return Storage17.damagetag17.get("stone");

		case IRON: 
			return Storage17.damagetag17.get("iron");

		case GOLD:
			return Storage17.damagetag17.get("gold");

		case DIAMOND:
			return Storage17.damagetag17.get("diamond");
			
		case NETHERITE:
			return Storage17.damagetag17.get("netherite");
